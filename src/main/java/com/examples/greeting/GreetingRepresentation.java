 ...
 */
@Resource
@ApiModel(value = "Greeting", description = "A representation representation")
public class GreetingRepresentation {
    ...
    @ApiModelProperty(
            ...
            name = "representation",
            example = "Hallo",
            value = "the actual representation text.")
    ...
    @ApiModelProperty(
            ...
            name = "language",
            example = "English",
            value = "the language spoken for people using the actual representation.")
    ...
    @ApiModelProperty(
            ...
            name = "country",
            example = "England",
            value = "the country where the actual representation is used.")
