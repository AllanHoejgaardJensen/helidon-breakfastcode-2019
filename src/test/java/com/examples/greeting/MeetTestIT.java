...
class MeetTestIT {
    ...
    void testHelloWorld() {
        ...
        JsonObject jsonObject = client
                .target(getConnectionString("/meet"))
                .request()
        ...
        jsonObject = client
                .target(getConnectionString("/meet/Joe"))
                .request()
                .get(JsonObject.class);
        ...
        Response r = client
                .target(getConnectionString("/meet-representation/Hola"))
                .request()
                .put(Entity.entity("", MediaType.APPLICATION_JSON));
        Assertions.assertEquals(200, r.getStatus(), "PUT status code");

        jsonObject = client
                .target(getConnectionString("/meet/Jose"))
                .request()
                .get(JsonObject.class);
